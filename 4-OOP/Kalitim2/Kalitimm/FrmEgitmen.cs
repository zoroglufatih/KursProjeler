    ...
    public partial class FrmEgitmen : Form
    {
        ...
        private void FrmEgitmen_Load(object sender, EventArgs e)
        {
            for (int i = 1; i < 11; i++)
            {
                ...
                egt.Bolum = "Yazılım";
                egt.Brans = "Bilişim";
                egt.Adres.Cadde = FakeData.PlaceData.GetStreetName();
                egt.Adres.Ilce = FakeData.PlaceData.GetCounty();
                egt.Adres.Sehir = FakeData.PlaceData.GetCity();
                egt.Maas = FakeData.NumberData.GetNumber(10000, 80000);
                egt.Adres.No = FakeData.NumberData.GetNumber(1, 200);
                egt.Adres.Sokak = FakeData.PlaceData.GetStreetName();
                elist.Add(egt);
            }
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            listBox1.DataSource = secEgitmen.Adres.AdresAl();
        }
    }
}
